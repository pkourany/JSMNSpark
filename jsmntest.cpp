...
#define TOKEN_PRINT(t) \
	Serial.print("start: "); Serial.print((t).start); Serial.print(" end: "); Serial.print((t).end); \
	Serial.print(" type: "); Serial.print((t).type); Serial.println(" size: "); Serial.println((t).size)
...
void setup() {
    ...
    Serial.println("test primitive");
	test(test_primitive, "test primitive JSON data types");
    Serial.println("test string");
	test(test_string, "test string JSON data types");
    Serial.println("test partial string");
	test(test_partial_string, "test partial JSON string parsing");
    Serial.println("test partial array");
	test(test_partial_array, "test partial array reading");
    Serial.println("test array nomem");
	test(test_array_nomem, "test array reading with a smaller number of tokens");
    Serial.println("test unquoted keys");
	test(test_unquoted_keys, "test unquoted keys (like in JavaScript)");
    Serial.println("test objects array");
	test(test_objects_arrays, "test objects and arrays");
    Serial.println("test unicode chars");
